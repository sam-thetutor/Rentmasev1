...
dfx canister call token icrc1_transfer "(record { to = record { owner = principal \"htufu-7bjgg-mf643-tjqaa-mxvij-oxlra-wnaim-3s4lg-rvxws-zq7ux-nae\";}; amount = 1_000_000_000_000;})"